  ...
  const DATA = [
    {
      ...
      narrative: "TORBU began as STRIDE, a supervision platform for academic sports. We built a role-based system that captured daily activity and records and enabled supervisor visibility.",
    ...
    },
    {
      ...
      narrative: "Early prototypes exposed what structured environments demand. We moved engineering in-house and consolidated the system under full architectural control. We established stable multi-level permissions and audit-ready records. We rebranded as TORBU.",
