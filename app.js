...
(() => {
  ...
  const DATA = [
    ...
    },
    {
      ...
      summary: "We expanded into certification systems and workforce readiness, deepening compliance logic in regulated environments.",
      bullets: [
    ...
    },
    {
      ...
      summary: "We prepared the system for enterprise modernization environments that demand documentation discipline and audit resilience.",
      bullets: [
    ...
    },
    {
      ...
      takeaway:
        "When modernization becomes law, governance software becomes essential infrastructure.",
      final: true
    }
  ];
  ...
  // Render nodes
  nodesEl.innerHTML = DATA.map((d, i) => `
  ...
  // Render panels
  panelsEl.innerHTML = DATA.map((d, i) => `
  ...
  function scrollToPanel(panelEl){
    ...
    // Use your :target offset as guidance; this matches header height in your CSS
  ...
  // Node click -> header-aware scroll
